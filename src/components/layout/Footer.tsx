        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <a
              ...
              className="text-gray-400 hover:text-buttercup transition-colors duration-200 text-sm"
              data-cursor-hover
            >
              sabrina@feld.com
            </a>
            ...
            <div className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm text-gray-300 hover:text-buttercup transition-colors duration-200"
                  data-cursor-hover
                >
                  {link.label}
                </Link>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-gray-300 hover:text-buttercup transition-colors duration-200"
                aria-label="Email"
                data-cursor-hover
              >
