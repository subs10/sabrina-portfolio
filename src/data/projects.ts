...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      roleDetails: [
        "StackHawk Google Ad Campaign: Designed display ads for Google Ads campaigns, balancing brand identity with conversion-focused messaging in constrained formats.",
